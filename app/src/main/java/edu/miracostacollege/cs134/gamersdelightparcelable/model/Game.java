...
public class Game implements Parcelable {
    ...
    /**
     * Describe and special contents of this object (files, video, audio)
    ...
    //private constructor to create a new Game from that Parcel
    ...
    public static final Parcelable.Creator<Game> CREATOR = new Creator<Game>() {
        ...
        /**
         * Allows the creation of an array of Game objects from the JSON file.
